...
<div class="message">
	{#if error}
		<span in:fade class="error">
      {error}<br>
      Currently, subscribing to the newsletter is not supported.<br>
      This is to avoid publicizing API keys,
      as the site is currently hosted on a public server.
</span>
	{/if}
